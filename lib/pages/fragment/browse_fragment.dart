...
import 'package:taufiqsejati_motobike/controllers/browse_newest_controller.dart';
...
class _BrowseFragmentState extends State<BrowseFragment> {
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      //   'name': 'Enfielding Pro',
      //   'image':
      //       'https://s3-alpha-sig.figma.com/img/547c/99d8/59cc8ebaeebcc6144f1f343ab1c55d96?Expires=1725235200&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=aCLVgOgqG79hoblv7lreFx0gx4in4CrZlqxUzEXwBW5i3P5XATSCW4WiImtB55r7Mz4EhN8FtEE1EPSG03zVqGQLoxmb7BlXE98O7CfBWNy~mB6irEN17OOWmnxkcvPXe50A02~BucEmphS9Jk2fOCpSU0kiRTB-APT73wBz5jdNaScXtkiKcULnSqqUDVltWjsHg7S7k8qEWseu64k9hriRToDDtv2s~89XSsDb~EFdMaYDY6s9HOcMDIOW2iclvgqN0IqHH6nSsef9elbDKZYEvCHXpXo6lVUJgoTN3cqHnVQISpte-TB5-HDl4sNW2t-01niu9DSowlkYDO6OWA__',
      // };
    });
    super.initState();
  }
